...
import ar.edu.itba.it.cg.yart.samplers.MultiJittered;
...
public class Metal2 extends MaterialAbstract {
	...
	private GlossySpecular glossyBRDF = new GlossySpecular();
	...
	public Color globalShade(ShadeRec sr, Stack stack) {
		...
		final Color f1 = glossyBRDF.sample_f(sr, wo, wi, pdf);
