...
public class YNode extends AbstractNode{
	...
	public YNode(BoundingBox box, List<GeometricObject> objects, final double splitPoint) {
		super(box, objects, splitPoint);
		this.splittingPlane = new Plane(new Point3(0, splitPoint, 0), Vector3d.yAxis());
	}
